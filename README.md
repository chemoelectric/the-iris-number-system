...
1. **Iris Textbook Volumes by Frédéric Blondel Custer (AsciiDoc & LatexMath Renderer)**
   - Multi-volume treatise viewer with instant switching between volumes:
     - **Volume I: The Iris Number System, Volume I (Fundamentals)** (`public/Iris_Number_System-01-Volume_I_Fundamentals.adoc`): Covers Postulates 0–9, Multiscale Resolution Analysis (MSRA), Cl(4,1,1) multivector differential & integral calculus, and the Master Field Equation.
      ...
      - **Volume III: The Iris Number System, Volume III (Applications to Geometry, Algebra, Topology, Lattices, Categories, Combinatorics)** (`public/Iris_Number_System-03-Volume_III_Geometry_Algebra_etc.adoc`): Constructive foundations for geometry, algebra, topology, lattices, categories, and combinatorics. Features Multivector Metric Space Completeness, Conformal Null Geometry Spinor Invariance, Clifford Blade Ideal Direct Sum Decomposition, Multivector Ring Homomorphism Invariance, Finite Discrete Topology Aperture Closure, Constructive Vernier Compactness Equivalence, Iris Grid Lattice Completeness, Modular Aperture Sublattices, Constructive Iris Category Duality, Monoidal Aperture Functor Coherence, Multivector Permutation Group Invariance, and Constructive Partition Function Identities.
