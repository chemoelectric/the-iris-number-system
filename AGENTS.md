...
- **C Standard**: C code shall be written targeting the C23 standard (`-std=c23`), unless Command Officer explicitly specifies otherwise or target platform constraints necessitate a different standard.
