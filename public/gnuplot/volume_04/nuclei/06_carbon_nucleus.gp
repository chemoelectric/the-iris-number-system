...
set style line 4 lc rgb "#6d2800" lw 1.3              # Amber: Central Recirculating Vortex
set style line 5 lc rgb "#111111" dt (18, 12) lw 1.8   # Distinct Dashed Dark Gray: Outer boundary

set label 1 "\\alpha_1 Cluster" at R_tri+0.4, 0, 0.65 center font "Sans-Bold,9.5" tc rgb "#8b0000"
set label 2 "\\alpha_2 Cluster" at -0.9, 1.6, 0.65 center font "Sans-Bold,9.5" tc rgb "#002855"
set label 3 "\\alpha_3 Cluster" at -0.9, -1.6, 0.65 center font "Sans-Bold,9.5" tc rgb "#004d20"
set label 4 "Central Vortex Hole" at 0, 0, -0.6 center font "Sans,9" tc rgb "#6d2800"
set label 5 "Outer Flux Boundary (G_N)" at 2.6, 0, -0.25 center font "Sans-Bold,8.5" tc rgb "#111111"
