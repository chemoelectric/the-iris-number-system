 ...
 * using modular SIMD Buchstab trees, prior OEIS anchors, Gilbreath
 * difference invariants, OpenMP multi-threading, compile-time fixed
 * limb arithmetic (LimbNumber), and GNU MP.
 */
