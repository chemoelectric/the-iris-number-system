...
contains
  ...
  function estimate_initial_x(n) result(x0)
    ...
    integer(i64) :: x0
    real(r64) :: fn, ln1, ln2, t1, t2, t3, approx, ln2_sq, ln1_sq, num2, den2
  ...
  function get_nth_prime(n) result(pn)
    ...
    integer(i64) :: pi_low, max_sieve_prime, num_small, range_len
    real(r64) :: fx0, log_x0, adj, rx0, lx0_23
    logical :: found
    ...
    if (n == 1_i64) then
      ...
      rx0 = real(x0, kind=r64)
      lx0_23 = log(rx0)
      lx0_23 = lx0_23 * 0.6666666666666666_r64
