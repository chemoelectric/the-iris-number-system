...
const volume5Object = {
  ...
  chapters: [
    ...
    },
    {
      ...
      summary: "This chapter formulates classical and high-frequency circuit theory from first principles on discrete multiscale resolution grids \\( \\mathcal { G } _ N \\), deriving Kirchhoff's voltage and current laws, resistors, capacitors (condensers), inductors (coils), transient RC and LC circuit dynamics, the tuning section of crystal radios, the full practical crystal receiver circuit with 0.25V threshold rectifier and 4000 ohm headphones, transformers, antennas, earth grounds as active RF counterpoises, grounded chassis, and electromagnetic shielding.",
      sections: [
        {
