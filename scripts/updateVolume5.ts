...
const sec1Content = [
  ...
  "   While spacetime field dynamics is fully described by the 64-dimensional Clifford Algebra \\( Cl ( 4 , 1 , 1 ) \\) under the Master Field Equation \\( D F = J \\), planar signal analysis requires far lighter geometric structures. For example:",
  ...
  "   * **The Spacetime Sub-Algebra \\( Cl ( 3 , 0 ) \\)**: Spanned by three spatial vectors, where the pseudoscalar \\( \\mathbf { I } = e _ 1 e _ 2 e _ 3 \\) satisfies \\( \\mathbf { I } ^ 2 = - 1 \\) and commutes with all grade elements, serving as a intrinsic 3D phase-rotation operator.",
  "",
